...
function renderMatrizVisibilidadeHTML(data) {
  ...
  let h = `
    ...
    <div id="matrizOuterScroll" style="overflow-x: auto; overflow-y: hidden; text-align: center; touch-action: pan-y pinch-zoom;">
...
function renderPainelTecnico(data, containerId) {
  try {
    ...
    html += `
      <div id="painelPrincipalOuterScroll" style="overflow-x: auto; overflow-y: hidden; margin: 24px 0; text-align: center; touch-action: pan-y pinch-zoom;">
