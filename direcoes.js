...
function getItemSVG(key) {
  ...
  if (key === 'spirit') {
    return `<svg width="22" height="22" viewBox="-12 -12 24 24" style="display: block; margin: 0 auto;"><text x="0" y="7" font-size="26" font-weight="400" fill="currentColor" text-anchor="middle">Φ</text></svg>`;
  }
